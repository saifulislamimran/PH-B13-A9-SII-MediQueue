      ...
      <div className="w-full max-w-[480px] z-10 animate-in fade-in zoom-in duration-500">
        <div className="glass-card bg-white/90 dark:bg-slate-800/95 border border-outline-variant/30 dark:border-slate-700 p-8 md:p-10 rounded-2xl shadow-[0px_4px_20px_rgba(0,0,0,0.05)]">
          ...
          <div className="mb-8 text-center md:text-left">
            <h1 className="font-headline-lg text-3xl font-bold text-gray-900 dark:text-gray-100 mb-2">Create Account</h1>
          ...
          <form onSubmit={handleRegister} className="space-y-4">
            ...
            <div className="space-y-1">
              <label className="font-label-md text-label-md text-gray-700 dark:text-gray-300 block font-semibold" htmlFor="name">
                Full Name
              </label>
              <div className="relative group">
                ...
                <input
                  className="w-full pl-10 pr-4 py-2.5 bg-surface dark:bg-slate-700 border border-outline-variant dark:border-slate-600 rounded-lg focus:ring-2 focus:ring-primary/20 focus:border-primary transition-all outline-none font-body-md text-body-md text-gray-900 dark:text-white placeholder:text-gray-400 dark:placeholder:text-gray-500"
                  id="name"
            ...
            {/* Photo URL */}
            <div className="space-y-1">
              <label className="font-label-md text-label-md text-gray-700 dark:text-gray-300 block font-semibold" htmlFor="photoURL">
                Photo URL (Optional)
              </label>
              <div className="relative group">
                <span className="material-symbols-outlined absolute left-3 top-1/2 -translate-y-1/2 text-outline dark:text-gray-400">
            ...
            <div className="space-y-1">
              ...
              <div className="relative group">
                ...
                <input
                  className="w-full pl-10 pr-12 py-2.5 bg-surface dark:bg-slate-700 border border-outline-variant dark:border-slate-600 rounded-lg focus:ring-2 focus:ring-primary/20 focus:border-primary transition-all outline-none font-body-md text-body-md text-gray-900 dark:text-white placeholder:text-gray-400 dark:placeholder:text-gray-500"
                  id="password"
                  placeholder="••••••••"
              ...
              <div className="pt-2 pb-1 space-y-1 text-xs">
                <p className="text-gray-700 dark:text-gray-300 font-semibold">Password Requirements:</p>
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-1">
                  <span className={`flex items-center gap-1 font-medium ${hasMinLength ? 'text-green-600 dark:text-green-400' : 'text-gray-400 dark:text-gray-500'}`}>
                    <span className="material-symbols-outlined text-[14px]">
                      {hasMinLength ? 'check_circle' : 'cancel'}
                    </span>
                    Min 6 chars
                  </span>
                  <span className={`flex items-center gap-1 font-medium ${hasUppercase ? 'text-green-600 dark:text-green-400' : 'text-gray-400 dark:text-gray-500'}`}>
                    <span className="material-symbols-outlined text-[14px]">
                      {hasUppercase ? 'check_circle' : 'cancel'}
                    </span>
                    1 Uppercase
                  </span>
                  <span className={`flex items-center gap-1 font-medium ${hasLowercase ? 'text-green-600 dark:text-green-400' : 'text-gray-400 dark:text-gray-500'}`}>
                    <span className="material-symbols-outlined text-[14px]">
            ...
            {/* Confirm Password */}
            <div className="space-y-1">
              <label className="font-label-md text-label-md text-gray-700 dark:text-gray-300 block font-semibold" htmlFor="confirmPassword">
                Confirm Password
              </label>
              <div className="relative group">
                <span className="material-symbols-outlined absolute left-3 top-1/2 -translate-y-1/2 text-outline dark:text-gray-400">
