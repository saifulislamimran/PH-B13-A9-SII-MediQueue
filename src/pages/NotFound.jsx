...
export default function NotFound() {
  ...
  return (
    <div className="min-h-[75vh] flex items-center justify-center px-6 bg-gradient-to-br from-surface to-surface-container-high dark:from-inverse-surface dark:to-background">
      <div className="max-w-md w-full text-center p-10 bg-surface-container-lowest/80 dark:bg-inverse-surface/90 border border-outline-variant/30 dark:border-white/10 rounded-3xl shadow-xl glass-card animate-in fade-in zoom-in duration-500">
        ...
        <h1 className="text-3xl font-display-lg font-bold text-on-surface mb-4 leading-tight">
          Diagnosis: <span className="text-error">Page Not Found</span>
        </h1>

        <p className="text-body-md text-on-surface-variant dark:text-surface-variant mb-8 leading-relaxed">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          ...
          <button
            ...
            className="px-6 py-3 border border-outline text-on-surface rounded-full font-semibold hover:bg-surface-container-high transition-all active:scale-95 flex items-center justify-center gap-2"
          >
